<template>
  <div>
    ...
    <div class="vice-nav">
      ...
      <router-link to>趣味小兵款帆布包</router-link>
    </div>
    <!-- 轮播+介绍 -->
        ...
        <div class="swiper-container swiper1">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <img src="../../../igg_server/images/details/package1.jpg" alt />
            </div>
            <div class="swiper-slide">
              <img src="../../../igg_server/images/details/package2.jpg" alt />
            </div>
            <div class="swiper-slide">
              <img src="../../../igg_server/images/details/package3.jpg" alt />
            </div>
            <div class="swiper-slide">
              <img src="../../../igg_server/images/details/package4.jpg" alt />
            </div>
            <div class="swiper-slide">
              <img src="../../../igg_server/images/details/package5.jpg" alt />
            </div>
            <div class="swiper-slide">
              <img src="../../../igg_server/images/details/package6.jpg" alt />
            </div>
          </div>
          <!-- Add Pagination -->
...
.top-rotation .swiper-container {
  width: 100%;
}
.top-rotation .swiper-slide {
  text-align: center;
  font-size: 18px;
  background: #fff;
...
.top-rotation .swiper-slide > img {
  width: 67%;
}
.top-rotation .swiper-button-next {
  display: block;
...
.top-rotation .swiper-button-prev {
  display: block;
...
.top-rotation .swiper-pagination-bullet {
  width: 14px;
  height: 14px;
}
.top-rotation .swiper-pagination-bullet-active {
